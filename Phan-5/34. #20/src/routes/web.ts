...
import { getCreateUserPage, getHomePage, postCreateUser, postDeleteUser, getViewUser, postUpdateUser } from "controllers/user.controller";     // Khi mà gõ controllers/* thì nó hiểu là ./src/controllers/* --> Được định nghĩa ở phần path trong user.service.ts ở phần path
...
const webRoutes = (app: Express) => {
  ...
  router.post("/handle-update-user/:id", postUpdateUser);   // Nếu không có dấu : thì code sẽ bị lỗi dấu : để hiểu đó là tham số
